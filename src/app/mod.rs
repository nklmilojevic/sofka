...
impl App {
    pub fn new(cluster: Cluster, tx: Sender<Msg>) -> Self {
        ...
        Self {
            ...
            argocd_expanded: HashSet::new(),
            argocd_children_request: 0,
            argocd_children_claim: None,
