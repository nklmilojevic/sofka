...
actions! {
    ...
    FavoriteNamespace1 => ("favorite_namespace_1", "select namespace shortcut 1 (favourite, else visited)"),
    FavoriteNamespace2 => ("favorite_namespace_2", "select namespace shortcut 2 (favourite, else visited)"),
    FavoriteNamespace3 => ("favorite_namespace_3", "select namespace shortcut 3 (favourite, else visited)"),
    FavoriteNamespace4 => ("favorite_namespace_4", "select namespace shortcut 4 (favourite, else visited)"),
    FavoriteNamespace5 => ("favorite_namespace_5", "select namespace shortcut 5 (favourite, else visited)"),
    FavoriteNamespace6 => ("favorite_namespace_6", "select namespace shortcut 6 (favourite, else visited)"),
    FavoriteNamespace7 => ("favorite_namespace_7", "select namespace shortcut 7 (favourite, else visited)"),
    FavoriteNamespace8 => ("favorite_namespace_8", "select namespace shortcut 8 (favourite, else visited)"),
    FavoriteNamespace9 => ("favorite_namespace_9", "select namespace shortcut 9 (favourite, else visited)"),
