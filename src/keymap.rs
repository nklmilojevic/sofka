...
actions! {
    ...
    DrainEmptyDir => ("drain_emptydir_data", "toggle deleting emptyDir data"),
    DrainIgnoreDaemonsets => ("drain_ignore_daemonsets", "toggle ignoring DaemonSet pods"),
    Clear => ("clear", "clear"),
...
const DEFAULTS: &[(&str, Action, &[&str])] = &[
    ...
    ("confirm", Action::DrainEmptyDir, &["e", "E"]),
    ("confirm", Action::DrainIgnoreDaemonsets, &["i", "I"]),
